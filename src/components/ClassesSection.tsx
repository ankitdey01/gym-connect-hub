...
const classes = [
  {
    ...
    description: "Build muscle and strength through targeted weight exercises",
    icon: Flame,
    duration: "45 min",
    level: "All Levels",
  },
  {
    ...
    description: "One-on-one coaching for personalized fitness goals",
    icon: Dumbbell,
    duration: "60 min",
    level: "Intermediate",
  },
  {
    ...
    description: "Improve cardiovascular health with various cardio exercises",
    icon: Heart,
    duration: "50 min",
    level: "All Levels",
  },
